...
namespace ari2._0.Controllers
{
    ...
    public class CustomerPublicStatusTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create(CustomerPublicStatusType type)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, CustomerPublicStatusType type)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            try
            {
                ...
                TempData["SuccessMessage"] = "Estado de Cliente eliminado exitosamente.";
                return RedirectToAction(nameof(Index));
            }
